...
function addSpecialDay() {
    ...
    switch ('' + date.getDate() + date.getMonth()) {
        ...
        case '152':
            ...
            var a = "";
            switch (n) {
                case 1: a = 'Herzlichen Glückwunsch Süsse';
                    break;
                case 2: a = 'Alles Gute zum Geburtstag Schöne';
                    break;
                case 3: a = 'Herzlichen Glückwunsch, Liebe meines Lebens';
                    break;
                default: a = 'Alles Liebe zum Geburtstag Anna';
            }    
            text = a;
            break;
        case '2411':
    ...
    new ical_parser(fam_cal, function(cal) {
        ...
        events.forEach(function(event) {
            if (i < 8) {
                ...
                var when = diff == 0 ? ('Heute') : (diff == 1 ? ('Morgen') : (moment(event.DTSTART).format('DD.MM.')))
