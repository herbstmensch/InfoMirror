        ...
        for (var i = 0; i < cal_array.length; i++) {
          ...
          //      console.log(cur_event);
            ...
            if (in_event) {
                ...
                if (type == 'DTSTART' || type == 'DTSTART;VALUE=DATE') {
                ...
                if (type == 'DTEND' || type == 'DTEND;VALUE=DATE') {
                    dt = this.makeDate(val);
                    val = dt.date;
                    //These are helpful for display
                ...
                cur_event[type == 'DTSTART;VALUE=DATE' ? 'DTSTART' : (type == 'DTEND;VALUE=DATE' ? 'DTEND' : type)] = val;
